/* Generar el valor promedio de ventas por cliente (mostrar el nombre cliente) para el año 2006 de los clientes que no están dentro de las ventas del 2005 */
...
/* Generar el valor total y el porcentaje equivalente para las ventas del año 2006 que no incluya el mes de febrero. El porcentaje debe ser sobre el total de ventas del año 2006 */
